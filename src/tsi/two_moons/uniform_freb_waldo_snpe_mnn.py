...
def main(hidden_layers,
    ...
    experiment_dir = f"results/snpe/uniform_setting/{EXPERIMENT_ID}"
    ...
    try:
        ...
        with open('results/snpe/snpe_uniform_prior.pkl', 'rb') as f:
        ...
        with open('results/snpe/snpe_uniform_prior.pkl', 'wb') as f:
    ...
    try:
        ...
        lf2i = LF2I(test_statistic=Posterior(poi_dim=POI_DIM, estimator=snpe_posterior, n_jobs=1))
    ...
    try:
        ...
        lf2i_waldo = LF2I(test_statistic=Waldo(poi_dim=2, estimator=snpe_posterior, estimation_method='posterior', num_posterior_samples=5_000,))
        logger = TrainingLogger(f'{experiment_dir}/logs')
        model, input_bounds = train_monotonic_nn(
            T_prime=(b_prime_params, b_prime_samples),
