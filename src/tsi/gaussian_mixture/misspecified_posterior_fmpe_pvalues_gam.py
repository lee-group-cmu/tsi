...
def main(num_augment):
    asset_dir = 'results/concept_shift/gaussian_reference/posterior_fmpe/p_values_gam'
    experiment_dir = f'results/concept_shift/gaussian_reference/posterior_fmpe/p_values_gam'
    ...
    try:
        ...
        b_prime_test_statistics = lf2i.test_statistic.evaluate(parameters=b_prime_params, samples=b_prime_samples, mode='critical_values')

        augmented_inputs, rejection_indicators = augment_calibration_set(
            test_statistics=b_prime_test_statistics,
            poi=b_prime_params,
        ...
        confidence_sets = lf2i.inference(
            ...
            calibration_model={'multiple_levels': estimator},
